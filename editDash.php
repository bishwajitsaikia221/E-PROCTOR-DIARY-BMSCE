...
function confirmationDelete(anchor)
{
   ...
   if(conf)
	...
	<?php require_once 'editDashProcess.php'; ?>
	...
	<?php
		...
		$result = $mysqli->query("SELECT * FROM sem5 WHERE username='1bf18mca04' ") or die($mysqli->error);
		//pre_r($result);
			...
			<?php
				while($row = $result->fetch_assoc()): ?>
					<tr>
						...
						<td>
							<a href="editDash.php?edit=<?php echo $row['ID']; ?>"
							class="btn btn-info">Edit</a>
							<a href="editDashProcess.php?delete=<?php echo $row['ID']; ?>"
	...
	?>
		...
		<form action="editDashProcess.php" method="POST">
