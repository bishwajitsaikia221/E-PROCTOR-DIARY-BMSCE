...
<html lang="en">
    <head>
        ...
        <title>MCA Admin| Add Staff Details< </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Add Staff Details</h2>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Enter the following Staff information</h5>
                                                </div>
                                            </div>
...
<?php }} ?>
													...
													<!--
<div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label">Degree</label>
                                                        <div class="col-sm-10">
