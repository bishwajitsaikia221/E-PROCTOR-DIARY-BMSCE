...
$username=isset($_SESSION['login']);
    $sql ="SELECT Password FROM admin_login WHERE UserName=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update admin_login set Password=:newpassword where UserName=:username";
